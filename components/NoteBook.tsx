    ...
    <div className="mt-16 flex w-full max-w-5xl min-w-0 gap-3 overflow-hidden rounded-2xl bg-linear-to-br from-[#1D3C5F] to-[#009689] p-4">
      ...
      <div className="flex min-w-0 flex-1 flex-col gap-3 md:grid md:grid-cols-[minmax(0,1fr)_auto]">
        ...
        >
          ...
          {/* Navigation */}
          <div className="relative mt-2 flex items-center gap-3 pl-6 sm:mt-10 sm:gap-4 sm:pl-8">
            <button
              type="button"
              onClick={() =>
                setActiveIndex(
        ...
        <div className="min-w-0 max-w-full overflow-hidden">
          <div className="scrollbar-none flex min-w-0 gap-2 overflow-x-auto pb-2 [&::-webkit-scrollbar]:hidden md:flex-col md:overflow-x-visible md:pb-0">
